...
const HomeSection = () => {
  return (
    <div className="w-full h-auto md:mt-12 rounded-md md:px-16 px-4 py-8">
      <h1 className='text-[2.3rem] text-center pb-5 text-headingColor font-bold '>Spin Your Energy For<br /> <span className='text-[2.3rem] text-center text-textRed'>Good Day Service</span></h1>
      <div className="grid md:grid-cols-3 item-center gap-2">
        <div className="shadow-sm p-2 rounded-xl w-full flex flex-1 flex-col items-center justify-center ">
          ...
          <div className='p-2 mt-3 flex flex-col items-center justify-center text-center'>
            ...
            <p className='text-[15px] text-textColor'>There are numerous of kitchen available to serve you each and everyday.</p>
          </div>
        </div>
        <div className="shadow-sm p-2 rounded-xl w-full flex flex-1 flex-col items-center justify-center ">
